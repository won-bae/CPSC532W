...
if __name__ == '__main__':
    ...
    for i in range(1,5):
        ...
        for j in range(num_samples):
            ...
            result, sig = evaluate_program(ast)
        ...
        np.save('results/evaluation/samples{}.npy'.format(i), results)

    np.save('results/evaluation/means.npy', means)
    np.save('results/evaluation/stds.npy', stds)
